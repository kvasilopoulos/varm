# Getting help with varm

Thanks for using varm. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/varm/issues) to make sure the 
